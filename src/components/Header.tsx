...
const Header: React.FC = () => {
    ...
    return (
        <motion.nav
            className="bg-navBg/30 text-navText py-4 fixed top-4 left-0 right-0 mx-6 md:mx-12 px-6 md:px-12 max-w-screen-2xl z-10 rounded-3xl shadow-lg backdrop-blur-md"
            style={{
